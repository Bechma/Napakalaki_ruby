...
class Player
  attr_reader :name, :level, :dead, :can_i_steal, :hidden_treasures, :visible_treasures, :pending_bad_consequence
  attr_accessor :enemy
  MAXLEVEL = 10
